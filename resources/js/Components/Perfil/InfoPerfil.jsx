...
export default function InfoPerfil({ user, isEntrenador }) {
    ...
    return (
        <div className="w-full lg:w-1/2 min-h-[700px] max-h-[700px] bg-gradient-to-r from-gray-400 to-lime-500 shadow-lg rounded-xl p-8 flex flex-col justify-between relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-900">
                <div>
                    <div className="mb-6 p-4 bg-slate-800 text-white rounded-lg transition-transform transform hover:scale-105 hover:bg-slate-900">
                        <p>
